...
namespace Smartwyre.DeveloperTest.Tests
{
    public class TestDataHelper
    {
        ...
        //public DbContextOptionsBuilder<dbContext> options;
    ...
    //    builder.UseInMemoryDatabase(databaseName: "DbMemoryTest");
    //    var dbContextOptions = builder.Options;

    //    dbContextTest = new dbContext(dbContextOptions);
    ...
    //public IEnumerable<Rebate> GetMockRebates()
    //{
